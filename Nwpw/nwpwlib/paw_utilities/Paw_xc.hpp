...
class Paw_xc {
  ...
  double *vxc_ae, *vxc_ps, *fdn_ae, *fdn_ps, *exc_ae, *exc_ps, *xc_temp,
      *xc_temp2;

  double *paw_xc_tlm, *paw_xc_dtlm_theta, *paw_xc_dtlm_phi;
  double *paw_xc_angle_phi, *paw_xc_cos_theta, *paw_xc_w_phi, *paw_xc_w_theta,
      *paw_xc_e;
  double *paw_vxc_ae, *paw_vxc_ps, *paw_dvxc_ae, *paw_dvxc_ps, *paw_xc_pot,
      *paw_xc_matr, *paw_xc_dmatr;

public:
  /* Constructors */
  Paw_xc(Ion *, Pneb *, Control2 &, const int *, const int *, const int *,
