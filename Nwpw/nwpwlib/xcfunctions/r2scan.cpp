   ...
   to nup, ndn, |grad nup|, |grad ndn|, and |grad n|.
    ...
    Exit - xce(*)  : PBE96 energy density
         ...
         - fdn(*,3): d(n*xce)/d|grad nup|, d(n*xce)/d|grad ndn|
           ...
           fdtau(*,2)
*/
void gen_r2SCAN_unrestricted(const int n2ft3d, double *dn_in, double *agr_in, double *tau_in,
 ...
 ****************************************/
/*
   This routine calculates the r2SCAN exchange-correlation
...
void gen_r2SCAN_restricted(const int n2ft3d, double *rho_in, double *agr_in, double *tau_in,
                           const double x_parameter, const double c_parameter,
                           double *xce, double *fn, double *fdn, double *fdtau) 
{
}
