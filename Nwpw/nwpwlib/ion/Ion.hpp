...
public:
  ...
  void Verlet_step(const double *fion, const double alpha) {
    ...
    for (auto ii = 0; ii < nion; ++ii) {
      ...
      rion2[3 * ii] =
          2 * sa1 * rion1[3 * ii] - sa2 * rion0[3 * ii] + scale * fion[3 * ii];
      rion2[3 * ii + 1] = 2 * sa1 * rion1[3 * ii + 1] -
                          sa2 * rion0[3 * ii + 1] + scale * fion[3 * ii + 1];
      rion2[3 * ii + 2] = 2 * sa1 * rion1[3 * ii + 2] -
                          sa2 * rion0[3 * ii + 2] + scale * fion[3 * ii + 2];
    }
  ...
  void Nose_step(const double ssr, const double *fion) {
    ...
    for (auto ii = 0; ii < nion; ++ii) {
      ...
      rion2[3 * ii] =
          2 * ssr * rion1[3 * ii] - smr * rion0[3 * ii] + scale * fion[3 * ii];
      rion2[3 * ii + 1] = 2 * ssr * rion1[3 * ii + 1] -
                          smr * rion0[3 * ii + 1] + scale * fion[3 * ii + 1];
      rion2[3 * ii + 2] = 2 * ssr * rion1[3 * ii + 2] -
                          smr * rion0[3 * ii + 2] + scale * fion[3 * ii + 2];
    }
