  ...
  void Newton_step(double eke, double eki) {
    if (nose_on) {
      ...
      for (auto m = 0; m < (Mchain - 1); ++m) {
        ...
        Xe2[m] =
            Xe1[m] + a * Xem[m] + (0.5 * time_step * time_step / Qe[m]) * FXe;
      ...
      Xe2[Mchain - 1] = Xe1[Mchain - 1] + time_step * Xem[Mchain - 1] +
                        (0.5 * time_step * time_step / Qe[Mchain - 1]) * FXe;
      ...
      for (auto n = 0; n < (Nchain - 1); ++n) {
        ...
        Xr2[n] =
            Xr1[n] + a * Xrm[n] + (0.5 * time_step * time_step / Qr[n]) * FXr;
      ...
      Xr2[Nchain - 1] = Xr1[Nchain - 1] + time_step * Xrm[Nchain - 1] +
                        (0.5 * time_step * time_step / Qr[Nchain - 1]) * FXr;
    }
  }
  ...
  void Verlet_step(double eke, double eki) {
    if (nose_on) {
      ...
      for (auto m = 0; m < (Mchain - 1); ++m) {
        ...
        double FXe = 2.0 * (eke_tmp - Ee0[m]);
        Xe2[m] = Xe0[m] + (Xe1[m] - Xe0[m] +
                           (0.5 * time_step * time_step / Qe[m]) * FXe) *
                              2.0 * sse;
      ...
      /* Last link of chain */
      double FXe = 2.0 * (eke_tmp - Ee0[Mchain - 1]);
      Xe2[Mchain - 1] = 2.0 * Xe1[Mchain - 1] - Xe0[Mchain - 1] +
                        (time_step * time_step / Qe[Mchain - 1]) * FXe;
      ...
      for (auto n = 0; n < (Nchain - 1); ++n) {
        ...
        /* integrate thermostat using modified verlet */
        double FXr = 2.0 * (ekr_tmp - Er0[n]);
        Xr2[n] = Xr0[n] + (Xr1[n] - Xr0[n] +
                           (0.5 * time_step * time_step / Qr[n]) * FXr) *
                              2.0 * ssr;
      ...
      Xr2[Mchain - 1] = 2.0 * Xr1[Mchain - 1] - Xr0[Mchain - 1] +
                        (time_step * time_step / Qr[Mchain - 1]) * FXr;
    }
  }
