...
double util_radial_switching(const double Rin, const double Rout, const double r)
{
   double s = 0.0;
   if (r<=Rin)
      s=0.0;
...
*/
void util_radial_dswitching(const double Rin, const double Rout, const double r, double *S, double *dS)
{
   *S  = 0.0;
   *dS = 0.0;
   if (r<=Rin)
