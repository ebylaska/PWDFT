 ...
 *                                         *
 *******************************************/
double util_gaunt(const bool iscmplx, const int l, const int m, const int l1,
                  const int m1, const int l2, const int m2) {
  if (iscmplx) {
 ...
 *                                         *
 *******************************************/
double util_gaunt2(const bool iscmplx, const int l, const int m, const int l1,
                   const int m1, const int l2, const int m2) {
  if (iscmplx)
 ...
 *                                         *
 *******************************************/
double util_gaunt3(const bool iscmplx, const int l, const int m, const int l1,
                   const int m1, const int l2, const int m2) {
  if (iscmplx)
