...
public:
  ...
  //   os << "     gas phase energy                 = " << std::scientific <<
  //   std::setw(19) << std::precision(10) << myborn.egas << std::endl; os << "
  //   sol phase energy                 = " << std::scientific << std::setw(19)
  //   << std::precision(10) << myborn.esol << std::endl; os << "
  //   (electrostatic) solvation energy = " << std::scientific << std::setw(19)
  //   << std::precision(10) << myborn.egas-myborn.esol
  //      << "(" << std::fixed << std::setw(8) << std::precision(3) <<
  //      (myborn.egas-myborn.esol)*27.2116*23.06 << " kcal/mol)" << std::endl;
