...
double Derivative7_1(const int i, const double f[])
{
  ...
  tmp = one_over_60 * (-147.0 * f[i] + 360.0 * f[i + 1] - 450.0 * f[i + 2] +
                       400.0 * f[i + 3] - 225.0 * f[i + 4] + 72.0 * f[i + 5] -
                       10.0 * f[i + 6]);
...
double Derivative7_2(const int i, const double f[])
{
  ...
  tmp = one_over_60 *
        (-10.0 * f[i - 1] - 77.0 * f[i] + 150.0 * f[i + 1] - 100.0 * f[i + 2] +
         50.0 * f[i + 3] - 15.0 * f[i + 4] + 2.0 * f[i + 5]);
...
double Derivative7_3(const int i, const double f[])
{
  ...
  tmp = one_over_60 *
        (+2.0 * f[i - 2] - 24.0 * f[i - 1] - 35.0 * f[i] + 80.0 * f[i + 1] -
         30.0 * f[i + 2] + 8.0 * f[i + 3] - 1.0 * f[i + 4]);
...
double Derivative7_4(const int i, const double f[])
{
  ...
  tmp = one_over_60 * (-1.0 * f[i - 3] + 9.0 * f[i - 2] - 45.0 * f[i - 1]

                       + 45.0 * f[i + 1] - 9.0 * f[i + 2] + 1.0 * f[i + 3]);
...
double Laplacian7_4(const int i, const double f[])
{
  ...
  tmp = one_over_180 *
        (+2.0 * f[i - 3] - 27.0 * f[i - 2] + 270.0 * f[i - 1] - 490.0 * f[i] +
         270.0 * f[i + 1] - 27.0 * f[i + 2] + 2.0 * f[i + 3]);
