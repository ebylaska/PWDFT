...
void Suggested_Param_RelTroullier(int *num_states_psp, int *n_psp, int *l_psp,
...
void solve_RelTroullier(int num_psp, int *n_psp, int *l_psp, int *s_psp,
  ...
  for (p = 0; p < (num_psp); ++p) {
    ...
    /* scattering state */
      ...
      R_Schrodinger_Fixed_E(l_psp[p] + 1, l_psp[p], Vl, Ngrid - 1, el, wl,
                            wl_prime);
