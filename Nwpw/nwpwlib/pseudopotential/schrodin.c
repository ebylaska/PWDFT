...
void R_Schrodinger(int n, int l, double v[], int *mch, double *Eig, double u[], double uprime[])
{
  ...
  double E, de, Emax, Emin, log_amesh, log_amesh2, gamma, L2, r2, sum, a, scale,
      m1scale, uout, upout, upin, *r, *f_upp, *upp;
...
void R_Schrodinger_Fixed_E(int n, int l, double v[], int match, double E, double u[], double uprime[])
{
  ...
  double log_amesh, log_amesh2, gamma, L2, r2, sum, *r, *f_upp, *upp;
                                  ...
                                  double *Eig, double u[], double uprime[])
{
  ...
  double E, de, Emax, Emin, log_amesh, log_amesh2, gamma, L2, r2, sum, uout,
      upout, upin, *r, *f_upp, *upp;
