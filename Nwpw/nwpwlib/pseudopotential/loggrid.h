...
extern void end_LogGrid(void);
extern double *alloc_LogGrid(void);
extern void dealloc_LogGrid(double *);
extern double *r_LogGrid(void);
extern int N_LogGrid(void);
extern double log_amesh_LogGrid(void);
extern double amesh_LogGrid(void);
extern double Integrate_LogGrid(double *);
extern double Integrate_LogGrid_na_nb(int, int, double *);
extern double Integrate2_LogGrid(int,int,double *);
extern void Zero_LogGrid(double *);
extern void Copy_LogGrid(double *, double *);
extern double Norm_LogGrid(int, double, double *);
extern void Derivative_LogGrid(const double [], double []);
