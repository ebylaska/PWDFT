...
void paw_solve_atom() {
  ...
  Total_E = E_kin + E_ion + E_Hartree + E_exchange + E_correlation;
...
double paw_get_atom_kinetic_energy() { return E_kin; }

double paw_get_atom_total_energy() { return Total_E; }

char *paw_get_atom_name() { return atom_name; }
char *paw_get_comment() { return comment; }
