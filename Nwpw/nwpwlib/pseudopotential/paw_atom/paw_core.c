...
void paw_set_core() {
  ...
  core_kin_energy =
      paw_get_atom_kinetic_energy() - paw_get_paw_kinetic_energy();
...
double *paw_get_pointer_core_density() { return core_density; }

double *paw_get_pointer_ps_core_density() { return ps_core_density; }

double paw_get_core_charge() { return core_charge; }

double paw_get_ps_core_charge() { return ps_core_charge; }

double paw_get_core_kinetic_energy() { return core_kin_energy; }
