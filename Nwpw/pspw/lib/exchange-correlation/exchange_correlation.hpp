...
public:
  ...
  friend std::ostream &operator<<(std::ostream &os, const XC_Operator &xc) 
  {
      ...
      if (xc.gga == 300)
         os << "VS98 - Meta GGA Functional\n";
      if (xc.gga == 301)
         os << "TPSS03 - Meta GGA Functional\n";
      if (xc.gga == 302)
         os << "SCAN - Meta GGA Functional\n";
      if (xc.gga == 303)
         os << "PKZB - Meta GGA Functional\n";
      if (xc.gga == 304)
         os << "M06-L - Meta GGA Functional\n";
      if (xc.gga == 305)
         os << "M06 - Meta GGA Functional\n";
      if (xc.gga == 306)
         os << "M06-2X - Meta GGA Functional\n";
      if (xc.gga == 307)
         os << "r2SCAN - Meta GGA Functional\n";
