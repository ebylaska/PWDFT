             ...
             double *agr, double *fn, double *fdn, double *dfdtau) 
{
   ...
   if (mypneb->ispin == 1) 
   {
      ...
      switch (gga) {
      case 300:
        gen_VS98_restricted(mypneb->n2ft3d, rho, agr, tau, 
                            x_parameter, c_parameter, 
                            xce, fn, fdn, dfdtau);
        break;
      case 301:
        gen_TPSS03_restricted(mypneb->n2ft3d, rho, agr, tau, 
                              x_parameter, c_parameter,
                              xce, fn, fdn, dfdtau);
        break;
      case 302:
        gen_SCAN_restricted(mypneb->n2ft3d, rho, agr, tau, 
                            x_parameter, c_parameter, 
                            xce, fn, fdn, dfdtau);
        break;
      case 303:
        gen_PKZB_restricted(mypneb->n2ft3d, rho, agr, tau, 
                            x_parameter, c_parameter, 
                            xce, fn, fdn, dfdtau);
        break;
      case 304:
        gen_M06L_restricted(mypneb->n2ft3d, rho, agr, tau, 
                            x_parameter, c_parameter,
                            xce, fn, fdn, dfdtau);
        break;
      case 305:
        gen_M06_restricted(mypneb->n2ft3d, rho, agr, tau, 
                           0.73, c_parameter, 
                           xce, fn, fdn, dfdtau);
        break;
      case 306:
        gen_M06_2x_restricted(mypneb->n2ft3d, rho, agr, tau, 
                              0.48, c_parameter,
                              xce, fn, fdn, dfdtau);
        break;
      case 307:
        gen_r2SCAN_restricted(mypneb->n2ft3d, rho, agr, tau, 
                              x_parameter, c_parameter,
                              xce, fn, fdn, dfdtau);
        break;
     
      default:
        gen_PBE96_BW_restricted(mypneb->n2ft3d, rho, agr, 
                                x_parameter, c_parameter, 
                                xce, fn, fdn);
   ...
   else 
   {
      ...
      switch (gga) {
      case 300:
        gen_VS98_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                              x_parameter, c_parameter, 
                              xce, fn, fdn, dfdtau);
        break;
      case 301:
        gen_TPSS03_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                                x_parameter, c_parameter, 
                                xce, fn, fdn, dfdtau);
        break;
      case 302:
        gen_SCAN_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                              x_parameter, c_parameter, 
                              xce, fn, fdn, dfdtau);
        break;
      case 303:
        gen_PKZB_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                               x_parameter, c_parameter, 
                               xce, fn, fdn, dfdtau);
        break;
      case 304:
        gen_M06L_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                              x_parameter, c_parameter, 
                              xce, fn, fdn, dfdtau);
        break;
      case 305:
        gen_M06_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                             0.73, c_parameter, 
                             xce, fn, fdn, dfdtau);
        break;
      case 306:
        gen_M06_2x_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                                0.46, c_parameter,
                                xce, fn, fdn, dfdtau);
        break;
      case 307:
        gen_r2SCAN_unrestricted(mypneb->n2ft3d, rho, agr, tau,
                                x_parameter, c_parameter, 
                                xce, fn, fdn, dfdtau);
        break;
     
      default:
        gen_PBE96_BW_unrestricted(mypneb->n2ft3d, rho, agr, 
                                  x_parameter, c_parameter, 
                                  xce, fn, fdn);
      }
