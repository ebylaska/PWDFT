...
public:
   ...
   ~Coulomb12_Operator() {
    ...
    double v_dielectric(const double *, const double *, 
                        const double *, const double *, 
                        double *);

    double v_dielectric_aperiodic(const double *, const double *, 
                                  const double *, const double *, 
                                  double *,
                                  nwpw_dplot *);

    double v_dielectric2_aperiodic(const double *, const double *,
                                   const double *, const double *,
                                   const double *, const double *,
