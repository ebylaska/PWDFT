...
public:
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const Molecule &mymolecule) {
    /* using old style c++ formatting */
    std::ios init(NULL);
    init.copyfmt(os);
    std::string eoln = "\n";
    os << "     ==============  energy results (Molecule object)  "
          "=============="
       << eoln;
    os << eoln << eoln;
    ...
    os << eoln;
    os << ionstream(" total     energy    : ", mymolecule.E[0],
                    mymolecule.E[0] / mymolecule.myion->nion);
    os << elcstream(" total orbital energy: ", mymolecule.E[1],
                    mymolecule.E[1] / mymolecule.neall);
    os << elcstream(" hartree energy      : ", mymolecule.E[2],
                    mymolecule.E[2] / mymolecule.neall);
    os << elcstream(" exc-corr energy     : ", mymolecule.E[3],
                    mymolecule.E[3] / mymolecule.neall);
    if (mymolecule.myelectron->is_v_apc_on())
      os << ionstream(" APC energy          : ", mymolecule.E[51],
                      mymolecule.E[51] / mymolecule.myion->nion);
    os << ionstream(" ion-ion energy      : ", mymolecule.E[4],
                    mymolecule.E[4] / mymolecule.myion->nion);

    os << eoln;
    os << elcstream(" kinetic (planewave) : ", mymolecule.E[5],
                    mymolecule.E[5] / mymolecule.neall);
    os << elcstream(" V_local (planewave) : ", mymolecule.E[6],
                    mymolecule.E[6] / mymolecule.neall);
    os << elcstream(" V_nl    (planewave) : ", mymolecule.E[7],
                    mymolecule.E[7] / mymolecule.neall);
    os << elcstream(" V_Coul  (planewave) : ", mymolecule.E[8],
                    mymolecule.E[8] / mymolecule.neall);
    os << elcstream(" V_xc    (planewave) : ", mymolecule.E[9],
                    mymolecule.E[9] / mymolecule.neall);
    if (mymolecule.myelectron->is_v_apc_on())
      os << ionstream(" K.S. V_APC energy   : ", mymolecule.E[52],
                      mymolecule.E[52] / mymolecule.myion->nion);

    os << " Viral Coefficient   : " << std::setw(19) << std::setprecision(10)
       << (mymolecule.E[9] + mymolecule.E[8] + mymolecule.E[7] +
           mymolecule.E[6]) /
              mymolecule.E[5];
    os << eoln;
    os << eoln;
    ...
    for (int i = 0; i < mymolecule.ne[1]; ++i)
      os << eig2stream(
          mymolecule.eig[i + nn], mymolecule.eig[i + nn] * ev,
