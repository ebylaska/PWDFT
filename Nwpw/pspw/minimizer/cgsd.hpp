...
extern double cgsd_cgminimize2(Molecule&, Geodesic2 *, double *, double *, double *, int, int, double, double);
extern double cgsd_bfgsminimize2(Molecule&, Geodesic2 *, pspw_lmbfgs2&, double *, double *, double *, int, int, double, double);
