...
*/
double cgsd_cgksminimize(Molecule &mymolecule, Geodesic *mygeodesic, double *E,
  ...
  total_energy = mymolecule.psi_1get_Tgradient0(G1); // needs to be modified
  ...
  *deltac = sum1;
  ...
  total_energy = mymolecule.energy0();
