...
int main(int argc, char* argv[])
{
   ...
   lammps_pspw_input_filename(MPI_COMM_WORLD,nwfilename,debugfilename);
   ...
   ierr += lammps_pspw_qmmm_minimizer_filename(MPI_COMM_WORLD,rion1,uion,fion,qion,&Eqm,true,true,debugfilename);
