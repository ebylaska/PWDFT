...
static double spring_bond_frag(const int nbond, const int indx[], const double Kr0[], const double rion[])
{
   ...
   for (auto b=0; b<nbond; ++b)
   {
      ...
      std::cout << "spring_bond_frag b=" << b
                << " ii=" << ii
                << " jj=" << jj
                << " dr=" << dr
                << " Kr0=" << Kr0[2*b] 
                << " Espring(ii,jj)=" << Kr0[2*b]*dr*dr << std::endl; 
...
static double spring_angle_frag(const int nangle, const int indx[], const double Kr0[], const double rion[])
{
   ...
   for (auto a=0; a<nangle; ++a)
   {
      ...
      std::cout << "spring_angle_frag a=" << a
                << " ii=" << ii
                << " jj=" << jj
                << " kk=" << kk
                << " q=" << q
                << " Kr0=" << Kr0[2*a] 
                << " Eangle(ii,jj,kk)=" << Kr0[2*a]*q*q << std::endl; 
...
double QMMM_Operator::spring_Energy(const double rion[])
{
   ...
   for (auto w1=0; w1<nfrag; ++w1)
   {
      ...
      if (nbs>0)
      {
         ...
         std::cout << "INTO spring_bond_frag bs1=" << bs1 
                   << " ks1=" << ks1
                   << " nbs=" << nbs
                   << " w1=" << w1
                   << std::endl;
      ...
      if (nas>0)
      {
         ...
         std::cout << "INTO spring_angle_frag bs1=" << ba1 
                   << " ks1=" << ks1
                   << " nas=" << nas
                   << " w1=" << w1
                   << std::endl;
