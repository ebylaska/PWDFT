                               ...
                               const int iswrite[])
{
   ...
   gpuprogram->kernel = clCreateKernel(gpuprogram->program, "vector_add", &ret);
...
int main() 
{
   ...
   printf("+---------------------------------------------------+\n");
   printf("| OpenCL DAXPY-like GPU timings on 2015 Macbook pro |\n");
   printf("+---------------------------------------------------+\n\n\n");
   ...
   bufsize[0] = LIST_SIZE; iswrite[0] = 0;
   bufsize[1] = LIST_SIZE; iswrite[1] = 0;
   bufsize[2] = LIST_SIZE; iswrite[2] = 1;
   ...
   nwpw_gpu_program_run(&gpuprogram,LIST_SIZE,64,nevents,events);
   time4 = clock();
